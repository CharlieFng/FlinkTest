...
public class BroadcastEmpCount
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<Tuple2<String, Integer>> employees = env.readTextFile("/Users/fengs4/Desktop/Udemy/Flink/src/main/resources/inputs/broadcast.txt")
        ...
        employees.writeAsText("/Users/fengs4/Desktop/Udemy/Flink/src/main/resources/outputs/broadcast-res.txt", FileSystem.WriteMode.OVERWRITE);
