...
public class ProcessTumbling {
    public static void main(String[] args) throws Exception
    {
        ...
        reduced.writeAsText("/Users/fengs4/Desktop/Udemy/Flink/src/main/resources/outputs/avg_process.txt", FileSystem.WriteMode.OVERWRITE);
        // execute program
