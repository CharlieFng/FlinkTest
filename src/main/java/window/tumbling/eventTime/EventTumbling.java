package window.tumbling.eventTime;
...
public class EventTumbling {
    public static void main(String[] args) throws Exception
    {
        ...
        sum.writeAsText("/Users/fengs4/Desktop/Udemy/Flink/src/main/resources/outputs/avg_event.txt", FileSystem.WriteMode.OVERWRITE);
