package window.sliding.eventTime;
...
public class EventSliding {
    public static void main(String[] args) throws Exception
    {
        ...
        sum.writeAsText("/Users/fengs4/Desktop/Udemy/Flink/src/main/resources/outputs/avg_slide_event.txt", FileSystem.WriteMode.OVERWRITE);
