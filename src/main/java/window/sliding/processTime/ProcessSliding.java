package window.sliding.processTime;
...
public class ProcessSliding {
    public static void main(String[] args) throws Exception
    {
        ...
        reduced.writeAsText("/Users/fengs4/Desktop/Udemy/Flink/src/main/resources/outputs/avg_slide.txt", FileSystem.WriteMode.OVERWRITE);
        // execute program
